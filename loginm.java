...
public class loginm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniproject/cartoon-farmer-holding-rake-dog-260nw-287561804.jpg"))); // NOI18N

        a.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Market 1", "Market 2", "Market 3" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(b, javax.swing.GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       // TODO add your handling code here:
        String name=(String) a.getSelectedItem();
        String password= b.getText();
        if(password.equals("Market 1"))
        {
            Market1 i=new Market1();
            i.setVisible(true);
            dispose();
        }
        else if(password.equals("Market 2"))
        {
            Market2 o=new Market2();
            o.setVisible(true);
            dispose();
        }
        else
        {
            Market3 o=new Market3();
            o.setVisible(true);
            dispose();
        }
